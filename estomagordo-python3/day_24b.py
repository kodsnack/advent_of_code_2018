...
def solve(infection, immune, boost):
    while infection and immune:
        ...
        while True:
            ...
            for j, target in enumerate(immune):
                ...
                target_attack_power = target[0] * (target[2] + boost)
        ...
        while True:
            ...
            for i, unit in enumerate(immune):
                ...
                earliness = [unit[0] * (unit[2] + boost), unit[3]]
                if earliness > earliest:
                    earliest = earliness
                    earliest_index = i
        ...
        while infection_attacked < len(infection_targeting) or immune_attacked < len(immune_targeting):            
            ...
            if infection_initiative > immune_initiative:
                ...
                damage = attacker[0] * (attacker[2] + boost)
    ...
    return -1 if infection else sum(unit[0] for unit in immune)
