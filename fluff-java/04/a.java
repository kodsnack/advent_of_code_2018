...
class Day04A {
    ...
    public static void main(String[] args) {
        ...
        int guardId = guardHashMap
                .entrySet()
                .stream()
                .max((g1, g2) -> g1.getValue().getTotalSleep() > g2.getValue().getTotalSleep() ? 1 : -1)
                .get()
                .getKey();

        System.out.println("Guard " + guardId + " sleeps " + guardHashMap.get(guardId).getTotalSleep() + " minutes");
        System.out.println("Guard " + guardId + " slept most often during minute " + guardHashMap.get(guardId).getMaxSleepMinute());
